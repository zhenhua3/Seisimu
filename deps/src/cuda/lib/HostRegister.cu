__host__ void acHostRegister(double *vx, int BD_nx_vx, int BD_ny_vx, int BD_nz_vx,
...
{
  cudaHostRegister(vx, BD_nx_vx*BD_ny_vx*BD_nz_vx*sizeof(double),cudaHostRegisterDefault);
  cudaHostRegister(vy, BD_nx_vy*BD_ny_vy*BD_nz_vy*sizeof(double),cudaHostRegisterDefault);
  cudaHostRegister(vz, BD_nx_vz*BD_ny_vz*BD_nz_vz*sizeof(double),cudaHostRegisterDefault);
  cudaHostRegister(tpp, BD_nx_tpp*BD_ny_tpp*BD_nz_tpp*sizeof(double),cudaHostRegisterDefault);
  cudaHostRegister(rho, BD_nx_tpp*BD_ny_tpp*BD_nz_tpp*sizeof(double),cudaHostRegisterDefault);
  cudaHostRegister(lambda, BD_nx_tpp*BD_ny_tpp*BD_nz_tpp*sizeof(double),cudaHostRegisterDefault);
}

__host__ void acHostUnRegister(double *vx, double *vy, double *vz,
  double *tpp, double *rho, double *lambda)
{
