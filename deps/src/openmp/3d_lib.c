...
double fd3d(double *in_wf, int idx0_in_wf, int idx1_in_wf, int idx2_in_wf, int idx3_in_wf, double *fdc)
 ...
 //********************************************//
 void el_body_tpp_x_3d(double *out_txx, double *out_tyy, double *out_tzz,
    ...
    void el_body_tpp_y_3d(double *out_txx, double *out_tyy, double *out_tzz,
                     int BD_nz_out, int BD_nx_out, int BD_ny_out,
                     int idx_i_out, int idx_j_out, int idx_k_out,
                     double *in_wf, int BD_nz_in, int BD_nx_in,
       ...
       void el_body_tpp_z_3d(double *out_txx, double *out_tyy, double *out_tzz,
                        int BD_nz_out, int BD_nx_out, int BD_ny_out,
                        int idx_i_out, int idx_j_out, int idx_k_out,
                        double *in_wf, int BD_nz_in, int BD_nx_in,
         ...
         void el_bound_tpp_y_3d(double *out_txx, double *out_tyy, double *out_tzz,
          ...
          void el_unlimited_bound_tpp_z_3d(double *out_txx, double *out_tyy, double *out_tzz,
           ...
           void el_free_bound_tpp_z_3d(double *out_txx, double *out_tyy, double *out_tzz,
            ...
            //********************************************//
            void ac_body_tpp_x_3d(double *out_tpp,
                             int BD_nz_out, int BD_nx_out, int BD_ny_out,
                             int idx_i_out, int idx_j_out, int idx_k_out,
                             double *in_wf, int BD_nz_in, int BD_nx_in,
               ...
               void ac_body_tpp_y_3d(double *out_tpp,
                                int BD_nz_out, int BD_nx_out, int BD_ny_out,
                                int idx_i_out, int idx_j_out, int idx_k_out,
                                double *in_wf, int BD_nz_in, int BD_nx_in,
                                int idx_k_in_start, double *lambda,
                                double dy, double dt, double *fdc)
                  {
                   double tmp, tmp_tpp;
                   int idx_out_tpp, idx0_in_wf, idx1_in_wf, idx2_in_wf, idx3_in_wf;
                   ...
                   tmp = fd3d(in_wf, idx0_in_wf, idx1_in_wf, idx2_in_wf, idx3_in_wf, fdc);
                   tmp_tpp = tmp / dy * *(lambda+idx_out_tpp) * dt;

                   *(out_tpp+idx_out_tpp) = *(out_tpp+idx_out_tpp) + tmp_tpp;
                  }

                  void ac_body_tpp_z_3d(double *out_tpp,
                                   int BD_nz_out, int BD_nx_out, int BD_ny_out,
                                   int idx_i_out, int idx_j_out, int idx_k_out,
                                   double *in_wf, int BD_nz_in, int BD_nx_in,
