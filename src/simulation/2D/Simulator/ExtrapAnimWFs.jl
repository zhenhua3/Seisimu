...
function AnimWFs(OptPath::String, WF1::WF2D, WF2::WF2D, WFSize::WF2DSize,
    medium::Model, source::Array{Source}, FD::NSFDMtx,
  ...
  wbox=6, hbox=6, clip = 1.0, cmap="seismic", aspect="auto",
  interval=40, vmax=1, vmin=-1)
